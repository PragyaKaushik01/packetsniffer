...
public class Sniffer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        hexTextArea.setForeground(Color.BLACK);
        ...
        listButton.setBackground(new java.awt.Color(255, 255, 0));
        ...
        filterOptions.setBackground(new Color(0, 255, 255, 255));
        ...
        captureButton.setBackground(new java.awt.Color(0, 194, 5));
        ...
        stopButton.setBackground(new java.awt.Color(224, 2, 2));
    ...
    public static void main (String[] args) throws IOException, CaptureDeviceNotFoundException, CaptureDeviceOpenException 
    {
     ...
     System.out.println("OUTPUT="+System.getProperty("java.library.path"));
        ...
        packetTable.getSelectionModel().addListSelectionListener(new ListSelectionListener(){
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (captureState == false)
                    return;
                //Packet Info
                PacketStructure packet = checked.get((int) packetTable.getValueAt(packetTable.getSelectedRow(),NORMAL));
