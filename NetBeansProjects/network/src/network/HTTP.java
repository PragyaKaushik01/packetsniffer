...
public class HTTP extends PacketStructure {
    ...
    /*A type of packet that uses JPCAP for taking input for filtering  the header of incoming packets.*/
    ...
    public void SetProperties(Packet packet) {
        ...
        /* Taking input from user for filtering the packet header information*/
